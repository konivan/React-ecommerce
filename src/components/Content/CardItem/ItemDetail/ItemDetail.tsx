      ...
      <div className="selectItem-wrap">
        <div className="selectItem-content">
          ...
          <div className="selectItem-desc-wrap">
            ...
            <div>
              <div>
                <span className="font-bold">Диск:</span>{" "}
                <span className="ml-1">{selectItem[0].description.disk}</span>
              </div>
              <div>
                <span className="font-bold">Экран:</span>{" "}
                <span className="ml-1">{selectItem[0].description.screen}</span>
              </div>
              <div>
                <span className="font-bold">CPU:</span>{" "}
                <span className="ml-1">{selectItem[0].description.CPU}</span>
              </div>
              <div>
                <span className="font-bold">RAM:</span>{" "}
                <span className="ml-1">{selectItem[0].description.RAM}</span>
              </div>
              <div>
                <span className="font-bold">OS:</span>{" "}
                <span className="ml-1">{selectItem[0].description.OS}</span>
              </div>
            </div>
          </div>
          <div className="selectItem-price-wrap">
            <div className="selectItem-price">
              Стоимость: {selectItem[0].price}$
            </div>
            <button onClick={addHandler} className="selectItem-btn">
              <a
                href="#_"
